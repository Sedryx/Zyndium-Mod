...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ModArmorMaterials(String name, int durabilityMulitplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound,
                      float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
        this.durabilityMulitplier = durabilityMulitplier;
    ...
    public int getDurability(ArmorItem.Type type) {
        return BASE_DURABILITY[type.ordinal()] * this.durabilityMulitplier;
    }
    ...
    public String getName() {
        return ZyndiumMod.MOD_ID + ":" + this.name;
    }
